  ...
  if (!room) {
    ...
    function init(createOffer, partnerName, username) {
      pc[partnerName] = new RTCPeerConnection(h.getIceServer());
        pc[partnerName].username = username;
      ...
      pc[partnerName].ontrack = (e) => {
        ...
        if (document.getElementById(`${partnerName}-video`)) {
          ...
          videoHolder.appendChild(newVid);
          videoHolder.appendChild(metaInfo);
          ...
          if (speaker?.children.length == 0) {
            speaker.appendChild(videoHolder);
          } else {
            document.getElementById("videos").appendChild(videoHolder);
          }
...
document.getElementById('send-message').addEventListener('click',()=>{
    ...
    document.getElementById("end-meeting").addEventListener("click", (e) => {
      location.href = "/";
    });
